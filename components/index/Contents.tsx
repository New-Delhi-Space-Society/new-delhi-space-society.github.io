  ...
  return (
    <AppContainer>
      <SubHeadingContents title="Introduction">
        <KBody>
          With a goal of making advancement in space science and aerospace engineering, we are a group of space enthusiasts who formed the New Delhi Space Society, a chapter of the{" "}
